  ...
  return (
    <>
      ...
      <section className='flex flex-col items-center justify-center relative gap-6 w-full min-h-[80svh] lg:min-h-[75svh] z-[5] dark:bg-core'>
        <h1 className='text-center text-4xl sm:text-5xl lg:text-6xl px-4 text-core dark:text-white mt-16 max-w-4xl font-extrabold'>
          Turn Feedback Into Actionable Insights
        </h1>
        <h2 className='text-center font-schoolbell text-xl text-black/90 dark:text-white/90 max-w-md px-4'>
          FireFeed helps businesses seamlessly collect, analyze, and act on customer feedback using AI-driven intelligence.
        </h2>
        <button
        ...
        <div className='max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:px-6'>
          <div className='flex flex-col items-center justify-between mb-8 lg:flex-row text-center lg:text-start'>
            ...
            <p className='max-w-xl text-gray-500 sm:text-lg dark:text-gray-400'>
              FireFeed enables businesses to effortlessly capture, analyze, and leverage customer feedback, transforming it into actionable insights with the power of AI.
            </p>
          </div>
      ...
      <footer className='bg-core'>
        <div className='max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8'>
          ...
          <div className='mt-8 md:mt-0 md:order-1'>
            <p className='text-center text-lg text-white'>&copy; 2024 FireFeed, Inc. All Rights Reserved.</p>
          </div>
        </div>
      </footer>
    </>
